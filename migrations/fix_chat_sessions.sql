-- Migration pour corriger les tables de chat
...
-- Ajouter une contrainte de clé étrangère pour subject_id
ALTER TABLE `chat_sessions`
...
ADD COLUMN `metadata` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`metadata`)) AFTER `context_data`;
